...
@section('body')
    ...
    <div class="container keck-home" id="home-default">
        <div class="grid third gap-x-xxl no-row-gap keck-home-grid">
            <div>
                @if(count($draftPages) > 0)
                    <div id="recent-drafts" class="card keck-card mb-xl">
                ...
                <div id="{{ auth()->check() ? 'recently-viewed' : 'recent-books' }}" class="card keck-card mb-xl">
            ...
            <div>
                @if(count($favourites) > 0)
                    <div id="top-favourites" class="card keck-card mb-xl">
                ...
                <div id="recent-pages" class="card keck-card mb-xl">
            ...
            <div>
                <div id="recent-activity" class="card keck-card mb-xl">
